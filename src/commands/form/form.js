...
module.exports = class extends Command {
    constructor(client) {
        super(client, {
            name: 'form',
            description: 'Formulário CONFIG BOT'
        })
    }
        ...
        createForm()
            .then(answers => {
                const embed = new MessageEmbed()
                    ...
                    this.client.channels.cache.get('881058950940884992').send({ embeds: [embed] })
            })
            .catch((erro) => {
                const embed = new MessageEmbed()
                    .setColor('RED')
        ...
        async function createForm() {
            ...
            for (const question of questions) {
                const embed = new MessageEmbed()
                    ...
                    .setFooter('Você tem 3 minutos para responder a esta pergunta.')
                ...
                if (question.options) {
                    ...
                    const collector = channel.createMessageCollector({ filter, max: 1, time: (3 * 60000) })
